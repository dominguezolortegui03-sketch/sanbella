...
export class SidebarComponent {
 menuOptions: SiderbarOption[]=[
  {icon:'assets/sidebarIcon/seguridad.svg',label:'Módulo 1: Seguridad',route:'/panel-admin/seguridad-admin'},
  {icon:'assets/sidebarIcon/seguimiento.svg',label:'Módulo 2: Seguimiento',route:'/panel-admin/seguimiento-admin'},
